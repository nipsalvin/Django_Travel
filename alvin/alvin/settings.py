"""
Django settings for alvin project.
...
WSGI_APPLICATION = 'alvin.wsgi.application'
...
STATIC_URL = '/static/'
STATICFILES_DIRS =[
    os.path.join(BASE_DIR, 'static')  #specify to django where to find the static files.
]
